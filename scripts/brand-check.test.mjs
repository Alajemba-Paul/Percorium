...
test("SKILL.md and AGENTS.md name the marker path and bound this script uses", (t) => {
  if (!existsSync(join(TEMPLATE_ROOT, "AGENTS.md")) || !existsSync(join(TEMPLATE_ROOT, ".grok/skills/og/SKILL.md"))) {
    t.skip("AGENTS.md or SKILL.md not present in exported repository");
    return;
  }
...
test("SKILL.md tells the pass to self-check with the flag this CLI accepts", (t) => {
  if (!existsSync(join(TEMPLATE_ROOT, ".grok/skills/og/SKILL.md"))) {
    t.skip("SKILL.md not present in exported repository");
    return;
  }
