    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <p className="text-sm text-muted-foreground max-w-2xl">
          Browse official preset indices (such as Mag 7 and Big Tech) or curate custom multi-stock portfolios of official Coinbase B20 tokenized stocks on Base. Share links or execute one-click buys.
        </p>
      </div>
      ...
      {/* 2. Custom Basket Curation (The Major Feature) */}
