...
const SEED: IndexSlab[] = [
  {
    ...
    inventory: { NVDAc: 120, AAPLc: 85, MSFTc: 60, GOOGLc: 60 },
    cashUsdc: 15420,
    supply: 45000,
  ...
  {
    id: "base-beta",
    name: "Crypto & High Beta Equities",
    symbol: "BBETA",
    creator: "Percorium",
    weights: { NVDAc: 40, COINc: 40, CRCLc: 20 },
    inventory: { NVDAc: 80, COINc: 95, CRCLc: 45 },
    cashUsdc: 8250,
    supply: 28000,
  ...
  },
  {
    ...
    symbol: "SOVAI",
    creator: "Percorium",
    weights: { NVDAc: 45, TSLAc: 30, MSFTc: 25 },
    inventory: { NVDAc: 150, TSLAc: 110, MSFTc: 75 },
    cashUsdc: 12400,
    supply: 35000,
  ...
  {
    id: "digital-treasury",
    name: "Digital Asset Balance Sheets",
    symbol: "DATS",
    creator: "Percorium",
    weights: { MSTRc: 50, COINc: 30, CRCLc: 20 },
    inventory: { MSTRc: 45, COINc: 80, CRCLc: 65 },
    cashUsdc: 9800,
    supply: 22000,
